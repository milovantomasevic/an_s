...
function tConvert(e) {
  var e = new Date(e),
    ...
    e = e[1],
    a = 12 <= t ? "PM" : "AM";
  return (t = (t %= 12) || 12) + ":" + (e = e < 10 ? "0" + e : e) + " " + a;
}
var invoice_new_obj,
  str_dt = function (e) {
    var e = new Date(e),
  ...
  Invoices = [
    {
      ...
      company_details: {
        ...
        email: "info@advanexus.com",
        website: "www.advanexus.com",
        ...
        `<tr>
                <th scope="row">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="chk_child" value="#an${e.invoice_no}">
                    </div>
                </th>
                <td class="id"><a href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="` +
        e.invoice_no +
        '" class="fw-medium link-primary">#an' +
        e.invoice_no +
        `</a></td>
...
function ViewInvoice(e) {
  ...
  localStorage.setItem("invoices-list", JSON.stringify(Invoices)),
    ...
    window.location.assign("details-invoices");
}
function EditInvoice(e) {
  ...
  localStorage.setItem("invoices-list", JSON.stringify(Invoices)),
    ...
    localStorage.setItem("invoice_no", e),
    window.location.assign("create-invoices");
}
