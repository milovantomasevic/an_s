...
if (navLinks && menuToggle) {
    ...
    window.addEventListener("load", function() {
        ...
        n = new bootstrap.Collapse(menuToggle, {
            toggle: !1
...
function counter() {
    ...
    }!e || e && Array.from(e).forEach(function(i) {
        ! function e() {
            var n = +i.getAttribute("data-target"),
                t = +i.innerText,
                o = n / 250;
            o < 1 && (o = 1), t < n ? (i.innerText = (t + o).toFixed(0), setTimeout(e, 1)) : i.innerText = l(n), l(i.innerText)
        }()
    })
}
counter();
